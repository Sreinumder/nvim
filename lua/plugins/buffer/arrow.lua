return {
  ...
  opts = {
    ...
    index_keys = "asdfgqwerzxcv;jk123456789bnmZXVBNM,hjklAFGHJKLtyuiopWRTYUIOP", -- keys mapped to bookmark index, i.e. 1st bookmark will be accessible by 1, and 12th - by c
    per_buffer_config = {
